...
router.post("/get-user-by-id",authMiddleware,userServices.getUserById);
router.post("/get-all-users",authMiddleware,userServices.getAllUsers)
router.post("/update-user-permissions",authMiddleware,userServices.updateUserPermissions);

//for-guest-user
// router.post("/get-user-by-id-id",userServices.getUserById);
