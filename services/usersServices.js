...
// router.post("/login",async(req,res)=>{
  ...
  try{
    ...
    if(userExists.isBlocked){
      return res.send({
        success:false,
        message:"Your Account is blocked.. Plese contact the Admin...",
        data:null,
      })
    }
...
//i am getting token from the frontend
...
module.exports = {register,login,getAllUsers,getUserById,updateUserPermissions};
